...
| [drills/](drills/) | Original practice material and its supporting tooling. |
| [lab/](lab/) | Keyless, teachable code demonstrations linked back to notes. |
| [cheatsheets/](cheatsheets/) | Compact review aids based on the blueprint and cited sources. |
| [flashcards/](flashcards/) | Short, blueprint-tagged retrieval-practice material. |
| [study-plans/](study-plans/) | Reusable schedules for different preparation windows. |
| [workflows](.github/workflows/) | Continuous-integration workflows for repository gates. |
| [tests/](tests/) | Structural checks that keep the note tree aligned with the blueprint. |
...
Choose a time budget, set a realistic total number of study hours, and assign those hours by the
published share: 33.1% to Applications and Integration, 16.8% to Model Selection and Optimization,
14.7% to Agents and Workflows, 11.0% to Prompt and Context Engineering, 10.6% to Tools and MCPs,
8.1% to Security and Safety, 3.1% to Claude Code, and 2.6% to Eval, Testing, and Debugging.

| Time budget | Path | How to keep it weighted |
|---|---|---|
| 1 week | First pass; revisit self-check gaps. | Use the listed share of every study hour. |
| 3 weeks | Notes, decisions, lab, then review. | Apply the listed share across the three weeks. |
| 6 weeks | Notes, drills and lab, then review. | Apply the listed share to every activity type. |

## Coverage

All note trees are intentionally scaffolds. They give contributors a consistent, weighted structure
without presenting uncited study material as settled guidance.
...
No braindumps: every practice item must be original and based only on the public blueprint; see
